...
int main() {
    ...
    PRINT_CONSTANT((gint) ADW_CONDITION_MAX_ASPECT_RATIO);
    PRINT_CONSTANT((gint) ADW_CONDITION_MAX_HEIGHT);
    PRINT_CONSTANT((gint) ADW_CONDITION_MAX_WIDTH);
    PRINT_CONSTANT((gint) ADW_CONDITION_MIN_ASPECT_RATIO);
    PRINT_CONSTANT((gint) ADW_CONDITION_MIN_HEIGHT);
    PRINT_CONSTANT((gint) ADW_CONDITION_MIN_WIDTH);
    ...
    PRINT_CONSTANT((gint) ADW_MULTI_CONDITION_ALL);
    PRINT_CONSTANT((gint) ADW_MULTI_CONDITION_ANY);
