...
pub const ADW_VERSION_S: *const c_char = b"1.0.0.alpha.4\0" as *const u8 as *const c_char;
...
#[repr(C)]
pub struct AdwButtonContent(c_void);
...
#[repr(C)]
pub struct AdwEnumListItem(c_void);
...
#[repr(C)]
pub struct AdwSplitButton(c_void);
