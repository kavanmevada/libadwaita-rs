...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AdwKeypadClass {
    pub parent_class: gtk::GtkWidgetClass,
}

impl ::std::fmt::Debug for AdwKeypadClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AdwKeypadClass @ {:?}", self as *const _))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
#[repr(C)]
pub struct AdwKeypad(c_void);

impl ::std::fmt::Debug for AdwKeypad {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AdwKeypad @ {:?}", self as *const _))
            .finish()
    }
}
...
extern "C" {
    ...
    // AdwKeypad
    //=========================================================================
    pub fn adw_keypad_get_type() -> GType;
    pub fn adw_keypad_new(
        symbols_visible: gboolean,
        letters_visible: gboolean,
    ) -> *mut gtk::GtkWidget;
    pub fn adw_keypad_get_column_spacing(self_: *mut AdwKeypad) -> c_uint;
    pub fn adw_keypad_get_end_action(self_: *mut AdwKeypad) -> *mut gtk::GtkWidget;
    pub fn adw_keypad_get_entry(self_: *mut AdwKeypad) -> *mut gtk::GtkEntry;
    pub fn adw_keypad_get_letters_visible(self_: *mut AdwKeypad) -> gboolean;
    pub fn adw_keypad_get_row_spacing(self_: *mut AdwKeypad) -> c_uint;
    pub fn adw_keypad_get_start_action(self_: *mut AdwKeypad) -> *mut gtk::GtkWidget;
    pub fn adw_keypad_get_symbols_visible(self_: *mut AdwKeypad) -> gboolean;
    pub fn adw_keypad_set_column_spacing(self_: *mut AdwKeypad, spacing: c_uint);
    pub fn adw_keypad_set_end_action(self_: *mut AdwKeypad, end_action: *mut gtk::GtkWidget);
    pub fn adw_keypad_set_entry(self_: *mut AdwKeypad, entry: *mut gtk::GtkEntry);
    pub fn adw_keypad_set_letters_visible(self_: *mut AdwKeypad, letters_visible: gboolean);
    pub fn adw_keypad_set_row_spacing(self_: *mut AdwKeypad, spacing: c_uint);
    pub fn adw_keypad_set_start_action(self_: *mut AdwKeypad, start_action: *mut gtk::GtkWidget);
    pub fn adw_keypad_set_symbols_visible(self_: *mut AdwKeypad, symbols_visible: gboolean);
