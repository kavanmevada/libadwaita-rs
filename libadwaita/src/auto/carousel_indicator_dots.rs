...
impl CarouselIndicatorDots {
    ...
    ///
    /// This method returns an instance of [`CarouselIndicatorDotsBuilder`] which can be used to create [`CarouselIndicatorDots`] objects.
...
impl CarouselIndicatorDotsBuilder {
    ...
    pub fn build(self) -> CarouselIndicatorDots {
        ...
        glib::Object::new::<CarouselIndicatorDots>(&properties)
            .expect("Failed to create an instance of CarouselIndicatorDots")
    }
