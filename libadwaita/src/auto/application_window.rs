...
pub trait AdwApplicationWindowExt: 'static {
    #[cfg(any(feature = "v1_3", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v1_3")))]
    #[doc(alias = "adw_application_window_add_adaptive_state")]
    ...
    #[cfg(any(feature = "v1_3", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v1_3")))]
    #[doc(alias = "adw_application_window_get_current_state")]
...
impl<O: IsA<ApplicationWindow>> AdwApplicationWindowExt for O {
    ...
    fn add_adaptive_state(&self, state: AdaptiveState) {
        unsafe {
            ffi::adw_application_window_add_adaptive_state(
    ...
    fn current_state(&self) -> Option<AdaptiveState> {
        unsafe {
            from_glib_none(ffi::adw_application_window_get_current_state(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
